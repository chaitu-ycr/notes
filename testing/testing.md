---
title: "🧪 The Art of Software Testing: A Practical Guide"
aliases:
...
- [SDLC](../sdlc/sdlc.md) — the lifecycle that defines when testing happens
- [ASPICE](../aspice/aspice.md) — automotive process quality model tied to verification and validation
- [CAN](../can/can.md) — vehicle network behavior that must be validated under test
- [UDS](../uds/uds.md) — diagnostic and fault-based validation paths
- [GitHub Actions](../github_actions/github_actions.md) — automated quality gates in CI/CD
