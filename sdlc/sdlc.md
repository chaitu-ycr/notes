---
title: "🚀 The Software Development Life Cycle (SDLC): Your Project's GPS"
aliases:
...
- [Testing](../testing/testing.md) — the verification layer used across SDLC stages
- [ASPICE](../aspice/aspice.md) — automotive process capability model aligned with software quality
- [Git](../git/git.md) — version control for team delivery
- [GitHub Actions](../github_actions/github_actions.md) — CI/CD automation in the delivery pipeline
- [Jenkins](../jenkins/jenkins.md) — self-hosted automation for build and release flow
