...
- [CAN](../can/can.md) — the core automotive bus that CANoe analyzes and simulates
- [UDS](../uds/uds.md) — diagnostics and ECU interaction patterns tested in CANoe
- [Vector CAPL](../vector_capl/vector_capl.md) — the scripting language used to automate CANoe behavior
- [Testing](../testing/testing.md) — CANoe is a major environment for validation and regression automation
- [Intrusion Detection System](../projects/IDS/IDS.md) — vehicle network security analysis often uses CANoe traces and simulation
